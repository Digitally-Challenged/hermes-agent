...
MEMORY_GUIDANCE = (
    ...
    "Save only facts explicitly supplied by the user or supported by observed tool results. "
    "Your own earlier assertions are not evidence. "
    "Current models, ports, service health, and performance belong in config or fresh "
    "observations, not persistent memory. If memory is full, skip the save and continue "
    "the user's task; consolidate separately when requested.\n"
...
TASK_COMPLETION_GUIDANCE = (
    ...
    "A blocked command, pending approval, or approval timeout means the command did "
    "not run. It is not an execution timeout or evidence of a network outage. "
    "Never invent infrastructure addresses or service identities; establish them "
    "from user input, configuration, or observed tool results before probing.\n"
